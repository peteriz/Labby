...
<head>
<title>Labby - Instrument list</title>
...
<script type="text/javascript" src="js/mainpages/instruments.js"></script> 
</head>
<body>
<div class="main">
  <div class="main_resize">
          	...
          	<% 
          		if (request.getSession().getAttribute("userRole") != null){
          			if(request.getSession().getAttribute("userRole").toString().equals("manager")) {
          				...
          				out.print("<li><a href=\"instruments.jsp\" class=\"active\"><span>Instruments</span></a></li>");
    ...
    <div class="main_right">
     ...
     <div class="clr"></div>
      <h2 style="padding:0px 0 0px 5px;">Lab Instruments list <br /></h2>
		<% 
      			PageUtils.createInstrumentsListTable(out,request,response);
      	%>
    </div>
    <div class="clr"></div>
  </div>
