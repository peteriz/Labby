...
<script type="text/javascript" charset="utf-8" src="js/mainpages/findreserve.js" ></script>
<style type="text/css">
	.ui-datepicker {
		font-family: Arial;
		font-size: 0.8em;
...
<div class="main">
  <div class="main_resize">
    ...
    <div class="main_right">
     ...
     <div class="clr"></div>
      <h2 style="padding:0px 0 0px 5px;">Reserve an instrument - Choose time slot</h2>
      <br/>
 		<%
 			PageUtils.createReservationTable(request,out);
 		%>
    </div>
    <div class="clr"></div>
  </div>
